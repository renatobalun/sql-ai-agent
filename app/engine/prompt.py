...
2) MANDATORY: prepend SHORT, HIGH-LEVEL constraints (e.g. NULL handling, limits),
   written in natural language — NOT SQL.
3) MANDATORY: LIMIT results when ranking, if user asks for top N, tell the tool to limit results to top N+20
